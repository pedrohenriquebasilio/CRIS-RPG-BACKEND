...
async function main() {
  ...
  const specializations = [
    ...
    // ===== ESPECIALIZAÇÕES DO SETTING: FEITICEIROS E MALDIÇÕES =====
    {
      nome: 'Feiticeiro',
      hpPorNivel: 8,
      energiaPorNivel: 12,
  ...
  for (const spec of specializations) {
    ...
    if (!existing) {
      ...
      // Update bonus fields on existing specializations
      ...
      // Upsert abilities for existing specializations (add missing ones)
  ...
  // ===== SKILLS =====
  const skills = [
    { nome: 'Atletismo', atributoBase: Atributo.FOR, permiteMaestria: true, descricao: 'Escalada, natação, corrida e saltos. Usado para superar obstáculos físicos.' },
    { nome: 'Intimidação', atributoBase: Atributo.FOR, permiteMaestria: true, descricao: 'Coagir alguém com força física ou presença ameaçadora.' },
    { nome: 'Acrobacia', atributoBase: Atributo.AGI, permiteMaestria: true, descricao: 'Equilíbrio, cambalhotas, manobras em combate. Evitar quedas e armadilhas.' },
    { nome: 'Furtividade', atributoBase: Atributo.AGI, permiteMaestria: true, descricao: 'Mover-se silenciosamente e passar despercebido.' },
    { nome: 'Destreza Manual', atributoBase: Atributo.AGI, permiteMaestria: true, descricao: 'Bater carteiras, abrir fechaduras, desativar armadilhas.' },
    { nome: 'Fortitude', atributoBase: Atributo.VIG, permiteMaestria: true, descricao: 'Resistir a venenos, doenças, fadiga e condições físicas adversas.' },
    { nome: 'Determinação', atributoBase: Atributo.VIG, permiteMaestria: true, descricao: 'Manter-se de pé sob condições extremas de dor ou exaustão.' },
    { nome: 'Arcana', atributoBase: Atributo.INT, permiteMaestria: true, descricao: 'Conhecimento sobre magia, rituais, criaturas mágicas e artefatos.' },
    { nome: 'História', atributoBase: Atributo.INT, permiteMaestria: true, descricao: 'Eventos históricos, linhagens nobres, guerras passadas.' },
    { nome: 'Investigação', atributoBase: Atributo.INT, permiteMaestria: true, descricao: 'Encontrar pistas, decifrar códigos, analisar evidências.' },
    { nome: 'Medicina', atributoBase: Atributo.INT, permiteMaestria: true, descricao: 'Estabilizar personagens moribundos, diagnosticar doenças.' },
    { nome: 'Natureza', atributoBase: Atributo.INT, permiteMaestria: true, descricao: 'Conhecimento sobre fauna, flora, terrenos e fenômenos naturais.' },
    { nome: 'Religião', atributoBase: Atributo.INT, permiteMaestria: true, descricao: 'Deuses, rituais sagrados, mortos-vivos e planos espirituais.' },
    { nome: 'Enganação', atributoBase: Atributo.PRE, permiteMaestria: true, descricao: 'Mentir de forma convincente, criar disfarces, manipular.' },
    { nome: 'Persuasão', atributoBase: Atributo.PRE, permiteMaestria: true, descricao: 'Influenciar alguém através de argumentos, charme ou diplomacia.' },
    { nome: 'Performance', atributoBase: Atributo.PRE, permiteMaestria: true, descricao: 'Atuar, cantar, dançar ou entreter uma audiência.' },
    { nome: 'Intuição', atributoBase: Atributo.PRE, permiteMaestria: true, descricao: 'Detectar mentiras, sentir intenções ocultas, perceber o humor de alguém.' },
    { nome: 'Percepção', atributoBase: Atributo.PRE, permiteMaestria: true, descricao: 'Notar detalhes do ambiente, detectar presença de criaturas ocultas.' },
  ];
  ...
  // ===== APTITUDES (inclui habilidades gerais e de combate do sistema) =====
  const aptitudes = [
    // --- Habilidades Gerais ---
    {
    ...
    // --- Habilidades de Combate Avançado ---
    {
    ...
    // --- Aptitudes de progressão (sistema existente) ---
    {
      nome: 'Golpe Poderoso',
  ...
  // First pass: create all aptitudes
  const aptitudeMap = new Map<string, string>(); // nome -> id
  ...
  // Second pass: update prerequisites with actual IDs
  for (const apt of aptitudes) {
