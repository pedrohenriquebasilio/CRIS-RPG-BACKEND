...
export declare class CreateSimplifiedNpcDto {
    campaignId: string;
    nome: string;
    hp: number;
    energia: number;
...
export declare class CreateFullNpcDto {
    campaignId: string;
    nome: string;
    hp: number;
    energia: number;
...
export declare class NpcController {
    ...
    createSimplified(dto: CreateSimplifiedNpcDto, user: any): Promise<{
        id: string;
        nome: string;
    ...
    createFull(dto: CreateFullNpcDto, user: any): Promise<{
        attributes: {
            id: string;
            FOR: number;
            AGI: number;
